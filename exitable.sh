#!/bin/bash
$JAVA_HOME/bin/java -Xmx30g -Xms30g  -Dsolr.useExitableDirectoryReader=true \
  -Dsolr.install.dir=/home/gus/projects/gus-asf/solr/testing/lw_exitable/solr-10.0.0-SNAPSHOT \
